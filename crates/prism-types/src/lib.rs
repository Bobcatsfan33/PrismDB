...
pub use embed::{
    Embedder, EmbeddingInput, EmbeddingPurpose, HashEmbedder, ModelArtifacts, MAX_EMBED_INPUT_BYTES,
};
...
pub use query::{ClusterSummary, Counters, Explain, Hit, MissingShard, Query, SearchResult};
